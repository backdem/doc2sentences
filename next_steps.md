...
git branch -M main
git remote add origin git@github.com:backdem/doc2sentences
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/backdem/repositories/new](https://github.com/organizations/backdem/repositories/new)
and create a new repository named `doc2sentences` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/backdem/doc2sentences/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
